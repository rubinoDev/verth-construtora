import { Container, Paragraph, ParagraphContainer } from './styles';
    ...
    <ImageBackground imageSrc="casa-piscina.png">
      ...
      <ParagraphContainer>
        <Paragraph>
          ...
          praesentium veniam minus harum ratione earum, esse excepturi perferendis velit soluta consequuntur quasi nisi
          odit molestias!
        </Paragraph>
        <Paragraph>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet voluptate distinctio ab sunt accusantium
